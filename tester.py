...
LOGGER = homework4.logging.get_logger("hw4-tester")
if ARGS.verbose:
...
INPUT_LEN, INPUT_HASH = homework4.utils.file_summary(INPUT_PATH)
...
RECV_LEN, RECV_HASH = homework4.utils.file_summary(RECV_PATH)
